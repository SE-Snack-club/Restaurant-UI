...
console.log("eee");
    ...
    axios
      .put(
        `${process.env.REACT_APP_API_URL}/catering/updateCusotmerDetails`,
        reqObj,
        {
              ...
              >
                ...
                <Row>
                  <Form.Group as={Row} md="10" controlId="validationCustom04">
                    <Form.Label>Date of Catering</Form.Label>
                    <Form.Control
                      type="date"
                      name="date"
                      required
                      ...
                      onChange={(e) => {
                        setDateOfCatering(e.target.value);
                      }}
                    />
                  </Form.Group>
                </Row>
                <Row className="mb-3">
                  ...
                  <Col>
                    <Form.Label>Type of Catering</Form.Label>
                    <Form.Select aria-label="Default select example" md="6">
